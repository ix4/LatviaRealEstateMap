      ...
      <div>
        ...
        <Container fluid>
          <Row>
            ...
            <Col xs={{ order: 1 }} md={{ size: 6, order: 3 }} lg="5" xl="4" className="pt-3 mb-3 pl-md-0">
              <SideMenu />
            </Col>
          </Row>
            ...
            <Col md="6" lg="5" xl="4" className="mt-3 pl-md-0">
              <Card color="primary">
                <CardBody>
                  ...
                  <CardText>Want to receive notifications about Brokalys platform updates to your email?</CardText>
